package xyz.gits.boot.job.worker.config;
...
import xyz.gits.boot.job.core.config.PowerJobProperties;
...
public class PowerJobConfig {
    ...
    @Bean
    public OhMyWorker initPowerJob() throws Exception {
